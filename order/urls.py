...
urlpatterns = [
    path("bills/<int:bill_id>/orders/<int:order_id>/", OrderView.as_view()),        # Admin only: all methods
    path("bills/<int:bill_id>/orders/", OrderView.as_view()),                       # Admin only: all methods
